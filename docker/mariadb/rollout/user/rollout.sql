...
insert into _roles (name, caption) values ("admin", "Admin role test");
...
insert into _users_roles(role_name, user_id) values ('admin', 1)
insert into _users_roles(role_name, user_id) values ('admin', 2)
